...
// UnmarshalJSON implements json.Unmarshaler.
func (j *BasicItemInfo) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["amount"]; raw != nil && !ok {
		return fmt.Errorf("field amount in BasicItemInfo: required")
	}
	if _, ok := raw["itemId"]; raw != nil && !ok {
		return fmt.Errorf("field itemId in BasicItemInfo: required")
	}
	if _, ok := raw["quality"]; raw != nil && !ok {
		return fmt.Errorf("field quality in BasicItemInfo: required")
	}
	type Plain BasicItemInfo
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = BasicItemInfo(plain)
	return nil
}
...
type ClaimEquipmentRecoveryRewardInput struct {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *ClaimEquipmentRecoveryRewardInput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in ClaimEquipmentRecoveryRewardInput: required")
	}
	if _, ok := raw["userId"]; raw != nil && !ok {
		return fmt.Errorf("field userId in ClaimEquipmentRecoveryRewardInput: required")
	}
	type Plain ClaimEquipmentRecoveryRewardInput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = ClaimEquipmentRecoveryRewardInput(plain)
	return nil
}

type ClaimEquipmentRecoveryRewardOutput struct {
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *ClaimEquipmentRecoveryRewardOutput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["failedReason"]; raw != nil && !ok {
		return fmt.Errorf("field failedReason in ClaimEquipmentRecoveryRewardOutput: required")
	}
	if _, ok := raw["success"]; raw != nil && !ok {
		return fmt.Errorf("field success in ClaimEquipmentRecoveryRewardOutput: required")
	}
	type Plain ClaimEquipmentRecoveryRewardOutput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = ClaimEquipmentRecoveryRewardOutput(plain)
	return nil
}
...
type DoEquipmentRecoveryInput struct {
	// NftCounts corresponds to the JSON schema field "nftCounts".
	NftCounts []int `json:"nftCounts" yaml:"nftCounts" mapstructure:"nftCounts"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *DoEquipmentRecoveryInput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["nftCounts"]; raw != nil && !ok {
		return fmt.Errorf("field nftCounts in DoEquipmentRecoveryInput: required")
	}
	if _, ok := raw["nftIds"]; raw != nil && !ok {
		return fmt.Errorf("field nftIds in DoEquipmentRecoveryInput: required")
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in DoEquipmentRecoveryInput: required")
	}
	if _, ok := raw["userId"]; raw != nil && !ok {
		return fmt.Errorf("field userId in DoEquipmentRecoveryInput: required")
	}
	type Plain DoEquipmentRecoveryInput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = DoEquipmentRecoveryInput(plain)
	return nil
}

type DoEquipmentRecoveryOutput struct {
	// FailedReason corresponds to the JSON schema field "failedReason".
	FailedReason string `json:"failedReason" yaml:"failedReason" mapstructure:"failedReason"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *DoEquipmentRecoveryOutput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["failedReason"]; raw != nil && !ok {
		return fmt.Errorf("field failedReason in DoEquipmentRecoveryOutput: required")
	}
	if _, ok := raw["success"]; raw != nil && !ok {
		return fmt.Errorf("field success in DoEquipmentRecoveryOutput: required")
	}
	type Plain DoEquipmentRecoveryOutput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = DoEquipmentRecoveryOutput(plain)
	return nil
}
...
type EquipmentRecoveryPoolStatus string

const EquipmentRecoveryPoolStatusClose EquipmentRecoveryPoolStatus = "close"
const EquipmentRecoveryPoolStatusOpen EquipmentRecoveryPoolStatus = "open"

var enumValues_EquipmentRecoveryPoolStatus = []interface{}{
	"close",
	"open",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EquipmentRecoveryPoolStatus) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_EquipmentRecoveryPoolStatus {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_EquipmentRecoveryPoolStatus, v)
	}
	*j = EquipmentRecoveryPoolStatus(v)
	return nil
}

type EquipmentRecoveryRecord struct {
	// CreateTime corresponds to the JSON schema field "createTime".
	CreateTime int `json:"createTime" yaml:"createTime" mapstructure:"createTime"`

	// InItems corresponds to the JSON schema field "inItems".
	InItems []BasicItemInfo `json:"inItems" yaml:"inItems" mapstructure:"inItems"`

	// OutItems corresponds to the JSON schema field "outItems".
	OutItems []BasicItemInfo `json:"outItems" yaml:"outItems" mapstructure:"outItems"`

	// OutTokenAmount corresponds to the JSON schema field "outTokenAmount".
	OutTokenAmount string `json:"outTokenAmount" yaml:"outTokenAmount" mapstructure:"outTokenAmount"`

	// PoolId corresponds to the JSON schema field "poolId".
	PoolId string `json:"poolId" yaml:"poolId" mapstructure:"poolId"`

	// PoolTypeId corresponds to the JSON schema field "poolTypeId".
	PoolTypeId int `json:"poolTypeId" yaml:"poolTypeId" mapstructure:"poolTypeId"`

	// Type corresponds to the JSON schema field "type".
	Type EquipmentRecoveryUserRewardType `json:"type" yaml:"type" mapstructure:"type"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EquipmentRecoveryRecord) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["createTime"]; raw != nil && !ok {
		return fmt.Errorf("field createTime in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["inItems"]; raw != nil && !ok {
		return fmt.Errorf("field inItems in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["outItems"]; raw != nil && !ok {
		return fmt.Errorf("field outItems in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["outTokenAmount"]; raw != nil && !ok {
		return fmt.Errorf("field outTokenAmount in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["poolTypeId"]; raw != nil && !ok {
		return fmt.Errorf("field poolTypeId in EquipmentRecoveryRecord: required")
	}
	if _, ok := raw["type"]; raw != nil && !ok {
		return fmt.Errorf("field type in EquipmentRecoveryRecord: required")
	}
	type Plain EquipmentRecoveryRecord
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = EquipmentRecoveryRecord(plain)
	return nil
}

type EquipmentRecoveryRewardItemConfig struct {
	// Amount corresponds to the JSON schema field "amount".
	Amount int `json:"amount" yaml:"amount" mapstructure:"amount"`
	...
	// ScorePerTokenAmount corresponds to the JSON schema field "scorePerTokenAmount".
	ScorePerTokenAmount int `json:"scorePerTokenAmount" yaml:"scorePerTokenAmount" mapstructure:"scorePerTokenAmount"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EquipmentRecoveryRewardItemConfig) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["amount"]; raw != nil && !ok {
		return fmt.Errorf("field amount in EquipmentRecoveryRewardItemConfig: required")
	}
	if _, ok := raw["itemId"]; raw != nil && !ok {
		return fmt.Errorf("field itemId in EquipmentRecoveryRewardItemConfig: required")
	}
	if _, ok := raw["quality"]; raw != nil && !ok {
		return fmt.Errorf("field quality in EquipmentRecoveryRewardItemConfig: required")
	}
	if _, ok := raw["scorePerTokenAmount"]; raw != nil && !ok {
		return fmt.Errorf("field scorePerTokenAmount in EquipmentRecoveryRewardItemConfig: required")
	}
	type Plain EquipmentRecoveryRewardItemConfig
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = EquipmentRecoveryRewardItemConfig(plain)
	return nil
}

type EquipmentRecoveryUserActionStatus string

const EquipmentRecoveryUserActionStatusFail EquipmentRecoveryUserActionStatus = "fail"
const EquipmentRecoveryUserActionStatusPending EquipmentRecoveryUserActionStatus = "pending"
const EquipmentRecoveryUserActionStatusSuccess EquipmentRecoveryUserActionStatus = "success"

var enumValues_EquipmentRecoveryUserActionStatus = []interface{}{
	"fail",
	"pending",
	"success",
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *EquipmentRecoveryUserActionStatus) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_EquipmentRecoveryUserActionStatus {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_EquipmentRecoveryUserActionStatus, v)
	}
	*j = EquipmentRecoveryUserActionStatus(v)
	return nil
}

type EquipmentRecoveryUserRewardType string

const EquipmentRecoveryUserRewardTypeBasic EquipmentRecoveryUserRewardType = "basic"
const EquipmentRecoveryUserRewardTypeExtra EquipmentRecoveryUserRewardType = "extra"

var enumValues_EquipmentRecoveryUserRewardType = []interface{}{
	"basic",
	"extra",
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *EquipmentRecoveryUserRewardType) UnmarshalJSON(b []byte) error {
	var v string
	if err := json.Unmarshal(b, &v); err != nil {
		return err
	}
	var ok bool
	for _, expected := range enumValues_EquipmentRecoveryUserRewardType {
		if reflect.DeepEqual(v, expected) {
			ok = true
			break
		}
	...
	if !ok {
		return fmt.Errorf("invalid value (expected one of %#v): %#v", enumValues_EquipmentRecoveryUserRewardType, v)
	}
	*j = EquipmentRecoveryUserRewardType(v)
	return nil
}
...
type GetEquipmentRecoveryPoolInput struct {
	// UserId corresponds to the JSON schema field "userId".
	UserId string `json:"userId" yaml:"userId" mapstructure:"userId"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *GetEquipmentRecoveryPoolInput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["userId"]; raw != nil && !ok {
		return fmt.Errorf("field userId in GetEquipmentRecoveryPoolInput: required")
	}
	type Plain GetEquipmentRecoveryPoolInput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = GetEquipmentRecoveryPoolInput(plain)
	return nil
}

type GetEquipmentRecoveryPoolOutput struct {
	...
	// ExtraRewardItems corresponds to the JSON schema field "extraRewardItems".
	ExtraRewardItems []BasicItemInfo `json:"extraRewardItems" yaml:"extraRewardItems" mapstructure:"extraRewardItems"`

	// ExtraRewardToken corresponds to the JSON schema field "extraRewardToken".
	ExtraRewardToken string `json:"extraRewardToken" yaml:"extraRewardToken" mapstructure:"extraRewardToken"`

	// PoolId corresponds to the JSON schema field "poolId".
	PoolId string `json:"poolId" yaml:"poolId" mapstructure:"poolId"`

	// PoolScore corresponds to the JSON schema field "poolScore".
	PoolScore int `json:"poolScore" yaml:"poolScore" mapstructure:"poolScore"`

	// PoolStatus corresponds to the JSON schema field "poolStatus".
	PoolStatus EquipmentRecoveryPoolStatus `json:"poolStatus" yaml:"poolStatus" mapstructure:"poolStatus"`

	// PoolTypeId corresponds to the JSON schema field "poolTypeId".
	PoolTypeId int `json:"poolTypeId" yaml:"poolTypeId" mapstructure:"poolTypeId"`

	// PreviousExtraReward corresponds to the JSON schema field "previousExtraReward".
	PreviousExtraReward PreviousExtraReward `json:"previousExtraReward" yaml:"previousExtraReward" mapstructure:"previousExtraReward"`

	// RewardItems corresponds to the JSON schema field "rewardItems".
	RewardItems []EquipmentRecoveryRewardItemConfig `json:"rewardItems" yaml:"rewardItems" mapstructure:"rewardItems"`

	// RewardToken corresponds to the JSON schema field "rewardToken".
	RewardToken RewardTokenConfig `json:"rewardToken" yaml:"rewardToken" mapstructure:"rewardToken"`

	// UserScore corresponds to the JSON schema field "userScore".
	UserScore int `json:"userScore" yaml:"userScore" mapstructure:"userScore"`
}

// UnmarshalJSON implements json.Unmarshaler.
func (j *GetEquipmentRecoveryPoolOutput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["expireTime"]; raw != nil && !ok {
		return fmt.Errorf("field expireTime in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["extraRewardItems"]; raw != nil && !ok {
		return fmt.Errorf("field extraRewardItems in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["extraRewardToken"]; raw != nil && !ok {
		return fmt.Errorf("field extraRewardToken in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["poolScore"]; raw != nil && !ok {
		return fmt.Errorf("field poolScore in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["poolStatus"]; raw != nil && !ok {
		return fmt.Errorf("field poolStatus in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["poolTypeId"]; raw != nil && !ok {
		return fmt.Errorf("field poolTypeId in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["previousExtraReward"]; raw != nil && !ok {
		return fmt.Errorf("field previousExtraReward in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["rewardItems"]; raw != nil && !ok {
		return fmt.Errorf("field rewardItems in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["rewardToken"]; raw != nil && !ok {
		return fmt.Errorf("field rewardToken in GetEquipmentRecoveryPoolOutput: required")
	}
	if _, ok := raw["userScore"]; raw != nil && !ok {
		return fmt.Errorf("field userScore in GetEquipmentRecoveryPoolOutput: required")
	}
	type Plain GetEquipmentRecoveryPoolOutput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = GetEquipmentRecoveryPoolOutput(plain)
	return nil
}

type GetEquipmentRecoveryRecordInput struct {
	// Index corresponds to the JSON schema field "index".
	Index int `json:"index" yaml:"index" mapstructure:"index"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *GetEquipmentRecoveryRecordInput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["index"]; raw != nil && !ok {
		return fmt.Errorf("field index in GetEquipmentRecoveryRecordInput: required")
	}
	if _, ok := raw["num"]; raw != nil && !ok {
		return fmt.Errorf("field num in GetEquipmentRecoveryRecordInput: required")
	}
	if _, ok := raw["poolTypeId"]; raw != nil && !ok {
		return fmt.Errorf("field poolTypeId in GetEquipmentRecoveryRecordInput: required")
	}
	if _, ok := raw["userId"]; raw != nil && !ok {
		return fmt.Errorf("field userId in GetEquipmentRecoveryRecordInput: required")
	}
	type Plain GetEquipmentRecoveryRecordInput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = GetEquipmentRecoveryRecordInput(plain)
	return nil
}

type GetEquipmentRecoveryRecordOutput struct {
	// Logs corresponds to the JSON schema field "logs".
	Logs []EquipmentRecoveryRecord `json:"logs" yaml:"logs" mapstructure:"logs"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *GetEquipmentRecoveryRecordOutput) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["logs"]; raw != nil && !ok {
		return fmt.Errorf("field logs in GetEquipmentRecoveryRecordOutput: required")
	}
	if _, ok := raw["logsCount"]; raw != nil && !ok {
		return fmt.Errorf("field logsCount in GetEquipmentRecoveryRecordOutput: required")
	}
	type Plain GetEquipmentRecoveryRecordOutput
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = GetEquipmentRecoveryRecordOutput(plain)
	return nil
}
...
type PreviousExtraReward struct {
	// ExtraRewardItems corresponds to the JSON schema field "extraRewardItems".
	ExtraRewardItems []BasicItemInfo `json:"extraRewardItems" yaml:"extraRewardItems" mapstructure:"extraRewardItems"`
	...
	// IsClaimed corresponds to the JSON schema field "isClaimed".
	IsClaimed bool `json:"isClaimed" yaml:"isClaimed" mapstructure:"isClaimed"`
	...
	// UserRewardItems corresponds to the JSON schema field "userRewardItems".
	UserRewardItems []BasicItemInfo `json:"userRewardItems" yaml:"userRewardItems" mapstructure:"userRewardItems"`

	// UserRewardToken corresponds to the JSON schema field "userRewardToken".
	UserRewardToken string `json:"userRewardToken" yaml:"userRewardToken" mapstructure:"userRewardToken"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *PreviousExtraReward) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["extraRewardItems"]; raw != nil && !ok {
		return fmt.Errorf("field extraRewardItems in PreviousExtraReward: required")
	}
	if _, ok := raw["extraRewardToken"]; raw != nil && !ok {
		return fmt.Errorf("field extraRewardToken in PreviousExtraReward: required")
	}
	if _, ok := raw["isClaimed"]; raw != nil && !ok {
		return fmt.Errorf("field isClaimed in PreviousExtraReward: required")
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in PreviousExtraReward: required")
	}
	if _, ok := raw["poolScore"]; raw != nil && !ok {
		return fmt.Errorf("field poolScore in PreviousExtraReward: required")
	}
	if _, ok := raw["poolTypeId"]; raw != nil && !ok {
		return fmt.Errorf("field poolTypeId in PreviousExtraReward: required")
	}
	if _, ok := raw["userRewardItems"]; raw != nil && !ok {
		return fmt.Errorf("field userRewardItems in PreviousExtraReward: required")
	}
	if _, ok := raw["userRewardToken"]; raw != nil && !ok {
		return fmt.Errorf("field userRewardToken in PreviousExtraReward: required")
	}
	if _, ok := raw["userScore"]; raw != nil && !ok {
		return fmt.Errorf("field userScore in PreviousExtraReward: required")
	}
	type Plain PreviousExtraReward
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = PreviousExtraReward(plain)
	return nil
}
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *RewardItemConfig) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["amount"]; raw != nil && !ok {
		return fmt.Errorf("field amount in RewardItemConfig: required")
	}
	if _, ok := raw["itemId"]; raw != nil && !ok {
		return fmt.Errorf("field itemId in RewardItemConfig: required")
	}
	type Plain RewardItemConfig
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = RewardItemConfig(plain)
	return nil
}

type RewardTokenConfig struct {
	// ScorePerTokenAmount corresponds to the JSON schema field "scorePerTokenAmount".
	ScorePerTokenAmount int `json:"scorePerTokenAmount" yaml:"scorePerTokenAmount" mapstructure:"scorePerTokenAmount"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *RewardTokenConfig) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["scorePerTokenAmount"]; raw != nil && !ok {
		return fmt.Errorf("field scorePerTokenAmount in RewardTokenConfig: required")
	}
	if _, ok := raw["tokenAmount"]; raw != nil && !ok {
		return fmt.Errorf("field tokenAmount in RewardTokenConfig: required")
	}
	type Plain RewardTokenConfig
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = RewardTokenConfig(plain)
	return nil
}
...
type UpdateEquipmentRecoveryUserClaimEvent struct {
	// BasicRewardToken corresponds to the JSON schema field "basicRewardToken".
	BasicRewardToken string `json:"basicRewardToken" yaml:"basicRewardToken" mapstructure:"basicRewardToken"`
...
// UnmarshalJSON implements json.Unmarshaler.
func (j *UpdateEquipmentRecoveryUserClaimEvent) UnmarshalJSON(b []byte) error {
	var raw map[string]interface{}
	if err := json.Unmarshal(b, &raw); err != nil {
		return err
	}
	if _, ok := raw["basicRewardToken"]; raw != nil && !ok {
		return fmt.Errorf("field basicRewardToken in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	if _, ok := raw["itemAmounts"]; raw != nil && !ok {
		return fmt.Errorf("field itemAmounts in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	if _, ok := raw["itemIds"]; raw != nil && !ok {
		return fmt.Errorf("field itemIds in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	if _, ok := raw["poolId"]; raw != nil && !ok {
		return fmt.Errorf("field poolId in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	if _, ok := raw["token"]; raw != nil && !ok {
		return fmt.Errorf("field token in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	if _, ok := raw["userId"]; raw != nil && !ok {
		return fmt.Errorf("field userId in UpdateEquipmentRecoveryUserClaimEvent: required")
	}
	type Plain UpdateEquipmentRecoveryUserClaimEvent
	var plain Plain
	if err := json.Unmarshal(b, &plain); err != nil {
		return err
	}
	*j = UpdateEquipmentRecoveryUserClaimEvent(plain)
	return nil
}
